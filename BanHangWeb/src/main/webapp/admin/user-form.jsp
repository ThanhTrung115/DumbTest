        ...
        <main class="admin-content">
            <div class="content-card">
                 ...
                 <form method="post" action="${pageContext.request.contextPath}/admin/user">
                    ...
                    <div class="form-group"><label>Điện thoại:</label><input class="form-control" name="DienThoai" value="${u.dienThoai}" type="tel"/></div>
                    <div class="form-group"><label>Địa chỉ:</label><input class="form-control" name="DiaChi" value="${u.diaChi}"/></div>
                    ...
                    <a href="${pageContext.request.contextPath}/admin/user" class="btn btn-cancel"><i class="fa-solid fa-xmark"></i> Hủy</a>
                 </form>
            </div>
        </main>
    </div>
